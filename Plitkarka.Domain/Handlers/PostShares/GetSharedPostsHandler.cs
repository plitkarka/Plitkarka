...
public class GetSharedPostsHandler : IRequestHandler<GetSharedPostsRequest, PaginationResponse<PostResponse>>
{
    private User _user { get; init; }
    private IRepository<UserEntity> _userRepository { get; init; }
    private IPaginationService<PostShareEntity> _paginationService { get; init; }
    private IImageService _imageService { get; init; }

    public GetSharedPostsHandler(
        IContextUserService contextUserService,
        IRepository<UserEntity> userRepository,
        IPaginationService<PostShareEntity> paginationService,
    ...
    public async Task<PaginationResponse<PostResponse>> Handle(GetSharedPostsRequest request, CancellationToken cancellationToken)
    {
