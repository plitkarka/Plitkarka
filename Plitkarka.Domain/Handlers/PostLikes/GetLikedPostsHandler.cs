...
public class GetLikedPostsHandler : IRequestHandler<GetLikedPostsRequest, PaginationResponse<PostResponse>>
{
    private User _user { get; init; }
    private IRepository<UserEntity> _userRepository { get; init; }
    private IPaginationService<PostLikeEntity> _paginationService { get; init; }
    private IImageService _imageService { get; init; }

    public GetLikedPostsHandler(
        IContextUserService contextUserService,
        IRepository<UserEntity> userRepository,
        IPaginationService<PostLikeEntity> paginationService,
    ...
    public async Task<PaginationResponse<PostResponse>> Handle(GetLikedPostsRequest request, CancellationToken cancellationToken)
    {
        ...
        Expression<Func<PostLikeEntity, bool>> predicate = item =>
            item.UserId == userId;
